      ...
      <Container>
        <div className={styles.grid}>
          <div className={styles.brand}>
            {/* Знак с надписью, а не эмблема с набранным названием: в подвале
                есть место, и фирменное начертание «Климат Лайн» стоит показать
                как оно нарисовано.

                Подпись под ним — живым текстом, хотя в присланном файле она
                набрана внутри картинки. Причин две. Во-первых, запечённая
                подпись не переживает уменьшения: на прежних 64 точках она
                вырождалась в серую полоску. Во-вторых, подпись тогда
                была бы одна в подвале и другая в шапке, где она и так живой
                текст: два слогана на одной странице. */}
            <Link
              to="/"
            ...
            <p className={styles.about}>
              Продажа, установка и обслуживание кондиционеров в {site.regionIn}.
