  ...
  return (
    <main>
      ...
      <Section
        ...
        lead="Выберите строку под свою комнату: в ней цена оборудования и монтажа. Цена оборудования — по самой доступной подходящей модели из каталога, посмотреть все можно по ссылке."
      >
        {/*
          Разбор таблицы перед таблицей, а не после неё.

          «07 BTU · 2,0 кВт» — язык продавцов и установщиков, и в строке
          прайса он читается как шум: человек пришёл узнать цену, а видит
          незнакомые цифры. Убрать их совсем нельзя — именно они стоят
          в названиях моделей, и без них покупатель не свяжет строку прайса
          с тем, что увидит в каталоге и у конкурента.

          Разбором, а не абзацем: у человека три разных вопроса, и ответ
          на каждый должен находиться отдельно, а не вычитываться из общего
          текста. Знающий пропустит блок целиком — на то и заголовок.
        */}
        <div className={styles.legend}>
          <h3 className={styles.legendTitle}>Как читать таблицу</h3>

          <dl className={styles.legendList}>
            <div>
              <dt>до 20 м²</dt>
              <dd>
                Площадь комнаты, на которую рассчитан кондиционер. Правило
                простое: киловатт холода на каждые десять квадратов при
                обычном потолке. Граница не жёсткая — если окна на юг,
                этаж верхний или в комнате много техники, берите следующую
                строку, с запасом.
              </dd>
            </div>

            <div>
              <dt>07 BTU и 2,0 кВт</dt>
              <dd>
                Это одно и то же число, записанное дважды. BTU — старая
                единица тепла; «07» означает 7000 BTU в час, и производители
                отбрасывают тысячи, оставляя эти две цифры в названии модели:
                «EACS-<b>09</b>HM» — та самая девятка на 25 м². В привычных
                киловаттах те же 7000 BTU — это 2,0.
              </dd>
            </div>

            <div>
              <dt>киловатты — это холод</dt>
              <dd>
                Не электричество. Кондиционер на 2,0 кВт холода тратит из
                розетки примерно втрое меньше, а экономичные модели — ещё
                меньше. На счёт за свет он влияет куда слабее, чем кажется
                по этой цифре.
              </dd>
            </div>
          </dl>
