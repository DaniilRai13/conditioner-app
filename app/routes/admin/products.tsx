...
export default function ProductsPage() {
  ...
  /**
   * Условия для общего кода витрины. Шум, компрессор, Wi-Fi и обогрев
   * здесь всегда выключены: по ним выбирает покупатель, а заказчику они
   * не нужны — панель без них короче на треть. Передаём нейтральные
   * значения, а не вырезаем условия из общей функции: витрине они нужны,
   * и развилка внутри неё стоила бы дороже четырёх констант здесь.
   */
